...
<body>
	...
	<script type="text/javascript">
		...
		function validate() {
			...
			if (!ok) {
				addError(msgD,
						'<p>Profile cannot be empty.</p><p>Enter "NILL" if not available</p>');
				return false;
			}
			...
			if (!ok) {
				addError(msgD,
						'<p>Education cannot be empty.</p><p>Enter "NILL" if not available</p>');
				return false;
			}
			...
			if (!ok) {
				addError(msgD,
						'<p>Certification cannot be empty.</p><p>Enter "NILL" if not available</p>');
				return false;
			}
			...
			if (!ok) {
				addError(msgD,
						'<p>Work Experience cannot be empty.</p><p>Enter "NILL" if not available</p>');
				return false;
			}
			...
			if (!ok) {
				addError(
						msgD,
						'<p>Recent Development cannot be empty.</p><p>Enter "NILL" if not available</p>');
				return false;
			}
