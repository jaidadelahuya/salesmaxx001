	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-10 form-page">
				<div class="row">
					<div class="col-sm-11">
						<div class="col-sm-3"><h4 class="text-danger" style="font-weight: bolder;">Edit Workshop</h4></div>
						<div class="col-sm-3">
							<a href="/sm-admin/add-workshop" class="text-muted page-action-menu" ><h4>New Workshop</h4></a>
						</div>
						<div class="col-sm-3">
							<a href="/sm-admin/workshop-schedule" class="text-muted page-action-menu" ><h4>Schedule Workshop</h4></a>
						</div>
						<div class="col-sm-3"><a href="#" class="text-muted page-action-menu" ><h4>View All</h4></a></div>
							...
							<div class="col-md-12 form-group">
								<label for="workshop-name">Workshop Name:</label> <select
									...
									<option>Interviewing, Hiring & Onboarding Top Sales
										Talent</option>
									<option>Introduction to Indirect Channel Sales</option>
									<option>Introduction to Sales Compensation</option>
									<option>Introduction to Sales Promotion</option>
						...
						<div class="col-md-6">
							...
							<div class="col-md-12 form-group">
								<label for="related-workshops">Related Workshops:</label> <select
									...
									<option value="PS-DWS-101">Developing A Winning Sales Presentation</option>
									...
									<option value="CDS-ICS-101">Introduction to Indirect
										Channel Sales</option>
									<option value="SM-ISC-204">Introduction to Sales
										Compensation</option>
									<option value="CDS-ISP-102">Introduction to Sales
										Promotion</option>
									<option value="NG-NPT-201">Negotiating Beyond Price &
										Tactical Approaches</option>
									<option value="PS-PSE-201">Presenting To Senior
										Executives</option>
									<option value="PSS-PS-101">Professional Selling
										Bootcamp</option>
									...
									<option value="RM-SSE-201">Selling to Senior
										Executives</option>
									<option value="NG-SSN-101">Situational Sales
										Negotiation</option>
