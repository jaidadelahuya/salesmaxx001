			...
			<form method="post" action="/coaching/get-coaching-preference">
				<div class="col-md-12" style="padding-left: 0px; text-align: center">
					...
					<div class="row">
						<div class="col-md-12">
							<div
								style="margin: 2%; background-color: #59983b; color: white; text-align: left"
								class="card inner">
								<div class="row">
									<div class="col-sm-4">
										<div class="radio">
											<label><input class="category" type="radio"
												value="Product Management" name="answer">Product
												Management</label>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="radio">
											<label><input class="category" type="radio"
												value="Sales Compensation" name="answer">Sales
												Compensation</label>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="radio">
											<label><input class="category" type="radio"
												value="Sales Force Selection" name="answer">Sales
												Force Selection</label>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-4">
										<div class="radio">
											<label><input class="category" type="radio"
												value="Sales Infrastructure" name="answer">Sales
									...
									<div class="col-sm-4">
										<div class="radio">
											<label><input class="category" type="radio"
												value="Sales Motivation" name="answer">Sales
												Motivation</label>
										</div>
									</div>
									<div class="col-sm-4">
