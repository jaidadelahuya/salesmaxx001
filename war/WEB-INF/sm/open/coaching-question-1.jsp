	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-12" style="padding-left: 0px; text-align: center">
					...
					<h2 style="text-shadow: 0 0 3px #3b5998;">What Kind of
						coaching do you need?</h2>
					<br>
					<div class="row">
						<div class="col-sm-4">
							<div style="margin: 2%; background-color: #3b5998; color: white"
								class="card inner">
								<div class="radio">
									<label><input type="radio" name="optradio"><strong>Interview</strong></label>
									<input class="url" type="hidden" value="/coaching/question2">
								</div>
								<p class="soln">Ex ea difficultate illae fallaciloquae, ut
									ait Accius, malitiae natae sunt.</p>
							</div>
						</div>
						<div class="col-sm-4">
							<div style="margin: 2%; background-color: #983b59; color: white"
								class="card inner">
								<div class="radio">
									<label><input type="radio" name="optradio"><strong>Sales Performance</strong></label>
									<input class="url" type="hidden"
										value="/coaching/question3">
								</div>
								<p class="soln">Lorem ipsum dolor sit amet, consectetur
									adipiscing elit</p>
							</div>
						</div>
						<div class="col-sm-4">
							<div style="margin: 2%; background-color: #59983b; color: white"
								class="card inner">
								<div class="radio">
									<label><input type="radio" name="optradio"><strong>Sales Management / Leadership</strong></label>
									<input class="url" type="hidden"
										value="/coaching/question4">
								</div>
								<p class="soln">Lorem ipsum dolor sit amet, consectetur
									adipiscing elit</p>
							</div>
